...
describe_fact(giulia, thomas_had_been_murdered, giulia_is_heart_broken) :- write('\'What do I need to do? Is he truly dead? He cannot be. He promised. I want him back...\''), nl, !.
/* TODO add more cases */
